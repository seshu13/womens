        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: 'Empowering Activities',
                  description: 'Carefully designed experiences that celebrate and enhance women\'s leadership and creativity',
                  icon: '💪'
                },
                {
                  title: 'Inclusive Environment',
                  description: 'Creating a safe and supportive space for all participants to connect and grow together',
                  icon: '🤝'
                },
                {
                  title: 'Lasting Impact',
                  description: 'Activities that foster meaningful connections and professional development',
                  icon: '✨'
                }
              ].map((feature, index) => (
                <div key={index} className="bg-[#F9F9F9] rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
                  <div className="text-4xl mb-4">{feature.icon}</div>
                  <h3 className="font-dm-sans text-xl font-bold text-[#053257] mb-3">
                    {feature.title}
                  </h3>
