        ...
        <div className="bg-gradient-to-r from-[#FF4C39] to-[#FFB473] p-6 relative overflow-hidden">
          ...
          <div className="relative text-white text-center">
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 bg-white/10 rounded-2xl p-3 backdrop-blur-sm">
                <Image
                  src="/logo.svg"
            ...
            <h2 className="text-3xl font-bold font-dm-sans mb-2">Celebrating Natural Leaders</h2>
            <div className="space-y-2">
              <p className="text-white/95 font-inter text-lg font-medium">Where Innate Leadership Meets Empowerment</p>
              <p className="text-white/85 font-inter text-sm">Honor the strength, wisdom, and vision that women bring to your organization</p>
            </div>
          </div>
